...
class Moed_A_part1_answersTest {
	...
	void testQ1_1() {
        ...
        if (Moed_A_part1_answers.calc(good_forms[0]) == 1)
        	System.out.println("testQ1_1 Success");
        else
			System.out.println("testQ1_1 Fail");

		if (Moed_A_part1_answers.calc(good_forms[1]) == 3)
			System.out.println("testQ1_1 Success");
		else
			System.out.println("testQ1_1 Fail");

		if (Moed_A_part1_answers.calc(good_forms[2]) == 2)
			System.out.println("testQ1_1 Success");
		else
			System.out.println("testQ1_1 Fail");

		if (Moed_A_part1_answers.calc(good_forms[3]) == 2)
			System.out.println("testQ1_1 Success");
		else
			System.out.println("testQ1_1 Fail");

		if (Moed_A_part1_answers.calc(good_forms[4]) == 2)
			System.out.println("testQ1_1 Success");
		else
			System.out.println("testQ1_1 Fail");
		//-----------------------
